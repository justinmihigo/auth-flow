...
const Signup: React.FC = () => {
    ...
    return (
        <View style={styles.cont}>
            ...
            <TextInput 
            placeholder="Enter your full name" placeholderTextColor={'#941ECA'} style={styles.inputs} selectionColor={'black'}></TextInput>
            <TextInput 
            placeholder="Enter your email" placeholderTextColor={'#941ECA'} style={styles.inputs} selectionColor={'black'}></TextInput>
            ...
            <Text style={{fontFamily:'Poppins_400Regular', color:'#941ECA'}}> Already have an account </Text>
            <TouchableOpacity onPress={() => navigation.navigate('Login' as never)}>
                <Text style={{fontFamily:'Poppins_400Regular', color:'#621486'}}>Login</Text>
            </TouchableOpacity>
